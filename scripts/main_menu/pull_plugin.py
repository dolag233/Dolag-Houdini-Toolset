...
driver = os.path.splitdrive(dolag_path)[0]

subprocess.call((shell_path, '/c', r'{} && cd "{}" && git pull'.format(driver, dolag_path)), stderr=sys.stderr, stdout=sys.stdout, shell=True)
print(r'{} && cd "{}" && git pull'.format(driver, dolag_path))
